 ...
 * <pre>
 * {@link QueryStringDecoderAllowNull} decoder = new {@link QueryStringDecoderAllowNull}("/hello?recipient=world&x=1;y=2");
 ...
 * <pre>
 * {@link QueryStringDecoderAllowNull} decoder = new {@link QueryStringDecoderAllowNull}("recipient=world&x=1;y=2", false);
 * ...
 * </pre>
 *
 ...
 *
 */
public class QueryStringDecoderAllowNull {
     ...
     */
    public QueryStringDecoderAllowNull(String uri) {
     ...
     * specified charset.
     */
    public QueryStringDecoderAllowNull(String uri, boolean hasPath) {
     ...
     * specified charset.
     */
    public QueryStringDecoderAllowNull(String uri, Charset charset) {
     ...
     * specified charset.
     */
    public QueryStringDecoderAllowNull(String uri, Charset charset, boolean hasPath) {
     ...
     * specified charset.
     */
    public QueryStringDecoderAllowNull(String uri, Charset charset, boolean hasPath, int maxParams) {
     ...
     * assume that the query string is encoded in UTF-8.
     */
    public QueryStringDecoderAllowNull(URI uri) {
        this(uri, HttpConstants.DEFAULT_CHARSET);
    }
     ...
     * specified charset.
     */
    public QueryStringDecoderAllowNull(URI uri, Charset charset) {
     ...
     * specified charset.
     */
    public QueryStringDecoderAllowNull(URI uri, Charset charset, int maxParams) {
     ...
     * specified charset.
     */
    public QueryStringDecoderAllowNull(URI uri, Charset charset, int maxParams, boolean semicolonIsNormalChar) {
    ...
    /**
     * Returns the uri used to initialize this {@link QueryStringDecoderAllowNull}.
     */
    public String uri() {
        return uri;
    }
